...
def register_all_tools():
    ...
    tool_registry.register(name="osiris.flights", func=osiris_flights, description="Fetch live ADS-B aircraft data.", permission=PermissionLevel.SAFE)
    tool_registry.register(name="osiris.earthquakes", func=osiris_earthquakes, description="Fetch recent seismic events.", permission=PermissionLevel.SAFE)
    ...
    tool_registry.register(name="osiris.space_weather", func=osiris_space_weather, description="Fetch geomagnetic and solar-flare conditions.", permission=PermissionLevel.SAFE)
    ...
    tool_registry.register(name="osiris.cyber_threats", func=osiris_cyber_threats, description="Fetch cyber-threat intelligence.", permission=PermissionLevel.SAFE)
    tool_registry.register(name="osiris.cyber_attacks", func=osiris_cyber_attacks, description="Fetch reported cyber-attack data.", permission=PermissionLevel.SAFE)
    ...
    tool_registry.register(name="osiris.scm_suppliers", func=osiris_scm_suppliers, description="Fetch critical supply-chain supplier telemetry.", permission=PermissionLevel.SAFE)
    tool_registry.register(name="osiris.sentinel", func=osiris_sentinel, description="Fetch Sentinel satellite scenes around coordinates.", permission=PermissionLevel.SAFE, parameters={"latitude": "number", "longitude": "number", "radius_km": "number", "days": "number"})
    tool_registry.register(name="osiris.cctv", func=osiris_cctv, description="Fetch public CCTV network records by region or radius.", permission=PermissionLevel.SAFE, parameters={"region": "string", "latitude": "number", "longitude": "number", "radius_km": "number"})
    tool_registry.register(name="osiris.cctv_stream_status", func=osiris_cctv_stream_status, description="Check reachability of a public camera stream URL.", permission=PermissionLevel.SAFE, parameters={"url": "string"})
    tool_registry.register(name="osiris.arcgis", func=osiris_arcgis, description="Query configured OSIRIS ArcGIS feature services.", permission=PermissionLevel.SAFE, parameters={"service": "string", "query": "string", "bbox": "string"})
