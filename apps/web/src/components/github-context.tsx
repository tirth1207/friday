...
export default function GithubContext() {
  ...
  return (
    <div className="fixed bottom-[17px] left-1/2 z-50 -translate-x-[288px] sm:-translate-x-[288px] max-sm:left-3 max-sm:translate-x-0">
      {open && (
        <div className="absolute bottom-11 left-0 w-[min(340px,calc(100vw-24px))] overflow-hidden rounded-2xl border border-white/10 bg-[#0b0d11]/98 shadow-2xl backdrop-blur-xl">
          <div className="flex items-center gap-2 border-b border-white/[0.07] px-3 py-2.5">
            <div className="flex h-7 w-7 items-center justify-center rounded-lg border border-white/10 bg-white/[0.04]"><Github size={14} className="text-white/60" /></div>
